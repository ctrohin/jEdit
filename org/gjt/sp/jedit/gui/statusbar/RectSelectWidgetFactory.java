...
public class RectSelectWidgetFactory implements StatusWidgetFactory
{
	...
	private static class RectSelectWidget extends AbstractLabelWidget
	{
		RectSelectWidget(View view)
		{
			super(view);
			label.setToolTipText(jEdit.getProperty("view.status.rect-tooltip"));
		}
		...
		public void update()
		{
			...
			if (textArea != null)
			{
				label.setEnabled(textArea.isRectangularSelectionEnabled());
				label.setText("Rect sel: " + textArea.isRectangularSelectionEnabled());
			}
		}
